    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/company-formation-consultancy-bahrain" element={<CompanyFormationConsultancyLanding />} />
          <Route path="/lp/company-formation-consultancy-v2" element={<CompanyFormationConsultancyLandingV2 />} />
          <Route path="/lp/company-formation-consultancy-modern" element={<CompanyFormationConsultancyLandingModern />} />
