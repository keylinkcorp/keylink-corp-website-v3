...
export default function CompanyFormationConsultancyLandingModernAds() {
  ...
  useEffect(() => {
    ...
    document.title = "Company Formation Consultancy Bahrain | Free Call (Ads)";
    ...
    let robots = document.querySelector(
      'meta[name="robots"][data-lp="company-formation-consultancy-modern-ads"]',
    ) as HTMLMetaElement | null;
    if (!robots) {
      robots = document.createElement("meta");
      robots.setAttribute("name", "robots");
      robots.setAttribute("data-lp", "company-formation-consultancy-modern-ads");
      document.head.appendChild(robots);
    }
    robots.setAttribute("content", "noindex, follow");

    let canonical = document.querySelector(
      'link[rel="canonical"][data-lp="company-formation-consultancy-modern-ads"]',
    ) as HTMLLinkElement | null;
    if (!canonical) {
      canonical = document.createElement("link");
      canonical.setAttribute("rel", "canonical");
      canonical.setAttribute("data-lp", "company-formation-consultancy-modern-ads");
      document.head.appendChild(canonical);
    }
    canonical.setAttribute("href", "https://keylinkcorp.com/lp/company-formation-consultancy-modern-ads");

    // Add FAQ JSON-LD (unique marker to avoid collisions)
    let ld = document.querySelector(
      'script[type="application/ld+json"][data-lp="cfc-modern-ads-faq"]',
    ) as HTMLScriptElement | null;
    if (!ld) {
      ld = document.createElement("script");
      ld.type = "application/ld+json";
      ld.setAttribute("data-lp", "cfc-modern-ads-faq");
