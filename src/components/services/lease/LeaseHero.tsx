...
import heroImage from "@/assets/lease-hero-professional.jpg";
...
const heroFeatures = [
  ...
  { icon: Scale, text: "Law No. 27/2014 Compliant" },
  { icon: Shield, text: "No Penalty Risk" },
];
      ...
      <div className="container py-32 lg:py-40">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="max-w-xl">
            ...
            >
              <span className="text-sm font-medium text-accent">RERA Registered Service</span>
            </motion.div>
            ...
            >
              <p className="text-sm text-muted-foreground">
                Registered with <span className="font-medium text-primary">RERA</span> • <span className="font-medium text-primary">Bahrain.bh</span> • <span className="font-medium text-primary">MOIC</span> • <span className="font-medium text-primary">eGovernment</span>
              </p>
            </motion.div>
          </div>
          ...
          >
            <div className="relative">
              ...
              <div className="rounded-2xl overflow-hidden shadow-sm relative">
                <img 
                  src={heroImage} 
                  alt="Landlord and tenant signing lease contract in Bahrain" 
                ...
                >
                  ...
                  <p className="text-2xl font-bold text-accent">BHD 50</p>
                </motion.div>
                ...
                >
                  ...
                  <p className="text-xs text-white/80">Leases Registered</p>
                </motion.div>
              </div>
            </div>
          </motion.div>
