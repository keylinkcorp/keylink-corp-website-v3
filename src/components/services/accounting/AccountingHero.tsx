...
export function AccountingHero({ heroImage }: AccountingHeroProps) {
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <motion.div variants={staggerItem}>
              <span className="section-badge">Accounting Services in Bahrain</span>
            </motion.div>
            ...
            >
              Your In-House Finance Team — Without the Overhead
            </motion.h1>
            ...
            >
              Bookkeeping. VAT Compliance. Audit Preparation. Real CFO Insights. 
              We handle your finances so you can focus on growing your business.
            </motion.p>
            ...
            <motion.div variants={staggerItem} className="mt-6">
              <p className="text-sm text-muted-foreground">
                Professional accounting from <span className="font-semibold text-accent">BHD 200/month</span>
              </p>
            </motion.div>
          </motion.div>
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="relative rounded-2xl overflow-hidden shadow-2xl bg-secondary/50">
              {heroImage ? (
                <img
                  src={heroImage}
                  alt="Professional accountant reviewing financial dashboard in modern Bahrain office"
