...
import heroImage from "@/assets/spc-hero-professional.jpg";
...
const heroFeatures = [
  ...
  { icon: Wallet, text: "BHD 50 Minimum Capital" },
  { icon: Clock, text: "3-14 Days Setup" },
];

export function SPCHero() {
  return (
      ...
      <div className="container py-32 lg:py-40">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="max-w-xl">
            ...
            >
              <span className="text-sm font-medium text-gold">Bahrain's Simplest Business Structure</span>
            </motion.div>
            ...
            >
              ...
              <motion.span variants={heroHeadlineLine} className="block text-gold relative">
                <span className="inline">Start Solo in 3-14 Days</span>
                <motion.span 
                  initial={{ scaleX: 0 }}
                  animate={{ scaleX: 1 }}
            ...
            >
              Launch your solo business in Bahrain with 100% foreign ownership. Register your Single Person Company from BHD 50 minimum capital with complete MOIC registration and LMRA support.
            </motion.p>
          ...
          >
            <div className="relative">
              ...
              <div className="rounded-2xl overflow-hidden shadow-sm relative">
                <img 
                  src={heroImage} 
                  alt="Solo entrepreneur registering Single Person Company in Bahrain" 
