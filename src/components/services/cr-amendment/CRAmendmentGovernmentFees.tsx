...
const feeData = [
  { type: "Activity Change", fee: "BHD 20-50/activity", processing: "2-3 days" },
  { type: "Shareholder Transfer", fee: "BHD 30", processing: "3-5 days" },
  { type: "Capital Adjustment", fee: "BHD 20", processing: "3-5 days" },
  { type: "Trade Name Change", fee: "BHD 30 + BHD 15", processing: "3-5 days" },
  { type: "Address Change", fee: "BHD 10", processing: "2-3 days" },
  { type: "Signatory Update", fee: "BHD 10", processing: "2-3 days" },
  { type: "Entity Conversion", fee: "BHD 50", processing: "5-10 days" },
  { type: "Manager/Director Change", fee: "BHD 20", processing: "3-5 days" }
];

const additionalFees = [
  { name: "Document notarization", fee: "BHD 10-50" },
  { name: "Arabic translation", fee: "BHD 20-100" },
  { name: "Security clearance (foreign)", fee: "BHD 50" }
];

export function CRAmendmentGovernmentFees() {
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <motion.h2 variants={staggerItem} className="text-3xl md:text-5xl font-bold mb-6 tracking-tight">
            CR Amendment <span className="text-accent">Government Fees</span> 2024
          </motion.h2>
          <motion.p variants={staggerItem} className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Transparent official fee breakdown for all amendment types
          </motion.p>
        </motion.div>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b-2 border-border bg-secondary/50">
                    <th className="text-left p-4 font-bold">Amendment Type</th>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Government fees are set by MOIC and subject to updates. Professional service fees 
                  are quoted separately during consultation. Keylink provides a complete itemized 
                  quote before starting any work—no hidden charges.
                </p>
              </div>
            </div>
          </div>
