...
const heroFeatures = [
  ...
  { icon: CheckCircle2, text: "100% Approval Rate" },
  { icon: Globe, text: "Remote Service" }
];

const trustLogos = [
  { icon: Shield, text: "MOIC Certified" },
  { icon: Building2, text: "Sijilat Expert" },
  { icon: FileCheck, text: "All Amendment Types" }
];
...
export function CRAmendmentHero() {
      ...
      <div className="container mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            >
              Activity changes, shareholder transfers, and capital adjustments processed through Sijilat. Keep your business compliant without the paperwork headache.
            </motion.p>
          ...
          >
            ...
            >
              <img
                src={crHeroImage}
                alt="Professional business consultant reviewing CR amendment documents"
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-sm font-medium text-muted-foreground">Amendments Filed</div>
                </div>
              </div>
            </motion.div>
