...
const painStats = [
  ...
  },
  {
    ...
    unit: "",
    label: "In fines",
    description: "For missed renewals"
  },
  {
    icon: Building2,
    value: "15+",
    unit: "Agencies",
    label: "To navigate",
    description: "Different processes"
  },
  {
    icon: AlertTriangle,
    value: "4-6",
...
export function PROProblemAgitation() {
        ...
        >
          ...
          <motion.div variants={staggerItem} className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              Government Paperwork Is Costing You More Than You Think
            </h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Every hour you spend in queues is an hour not spent growing your business.
            </p>
          </motion.div>
          ...
          >
            <blockquote className="text-xl md:text-2xl italic text-muted-foreground leading-relaxed">
              "If you've spent hours navigating ministries only to be told you're in the wrong line 
              with the wrong forms... you know exactly what we're talking about."
            </blockquote>
          </motion.div>
