...
const medicalRequirements = [
  ...
  "Conducted at approved health centers only"
];

export function VisaDocumentChecklists() {
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Required for application submission</p>
              </div>
            </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-blue-700 mb-4">
                      All work visa applicants must complete a medical fitness test at an approved 
                      health center in Bahrain before CPR card issuance.
                    </p>
