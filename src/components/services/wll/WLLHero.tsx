...
import { ArrowRight, Clock, Shield, Wallet, Users } from "lucide-react";
import { motion } from "framer-motion";
import { Button } from "@/components/ui/button";
import heroImage from "@/assets/wll-hero-professional.jpg";
...
const heroFeatures = [
  { icon: Users, text: "2-50 Shareholders Allowed" },
  { icon: Wallet, text: "BHD 20,000 Minimum Capital" },
  { icon: Clock, text: "5-7 Days Registration" },
];

export function WLLHero() {
  return (
      ...
      <div className="container py-32 lg:py-40">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="max-w-xl">
            ...
            >
              <span className="text-sm font-medium text-gold">Bahrain's Partnership-Ready Business Structure</span>
            </motion.div>
            ...
            >
              ...
              <motion.span variants={heroHeadlineLine} className="block text-gold relative">
                <span className="inline">Build Your Partnership in 5-7 Days</span>
                <motion.span 
                  initial={{ scaleX: 0 }}
                  animate={{ scaleX: 1 }}
          ...
          >
            <div className="relative">
              ...
              <div className="rounded-2xl overflow-hidden shadow-sm relative">
                <img 
                  src={heroImage} 
                  alt="Business partners forming WLL company in Bahrain" 
                ...
                >
                  ...
                  <p className="text-2xl font-bold text-gold">BHD 1,200</p>
                </motion.div>
