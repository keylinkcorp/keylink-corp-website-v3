...
import { ArrowRight, Phone, Award, Clock, FileText, Shield } from "lucide-react";
import { staggerContainer, staggerItem } from "@/lib/animations";
import heroImage from "@/assets/legal-hero-professional.jpg";
import { HeroReviewStrip } from "@/components/shared/HeroReviewStrip";

const featurePills = [
  { icon: Award, text: "Licensed Legal Consultants" },
  { icon: Clock, text: "10+ Years in Bahrain" },
  { icon: FileText, text: "500+ Contracts Drafted" },
  { icon: Shield, text: "MOIC & LMRA Expertise" },
];
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <motion.div variants={staggerItem}>
              <span className="section-badge">Legal Consultant Bahrain</span>
            </motion.div>
            ...
            >
              Trusted Legal Consulting for Business Success in Bahrain
            </motion.h1>
            ...
            >
              Navigate Bahraini commercial law with confidence. Expert contract drafting, 
              regulatory compliance, and legal due diligence — protecting your business 
          ...
          >
            <div className="relative rounded-2xl overflow-hidden shadow-lg">
              <img
                src={heroImage}
                alt="Legal consultant reviewing contract documents with business client in Bahrain"
