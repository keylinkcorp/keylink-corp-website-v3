...
const stats = [
  { icon: FileText, value: 500, suffix: "+", label: "MOAs Drafted" },
  { icon: CheckCircle2, value: 100, suffix: "%", label: "Approval Rate" },
  { icon: Clock, value: 48, suffix: "hr", label: "Avg Notarization" },
  { icon: Award, value: 10, suffix: "+", label: "Years Legal Expertise" }
];

export function MOATrustBar() {
