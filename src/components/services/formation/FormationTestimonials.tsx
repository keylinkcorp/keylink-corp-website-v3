...
const testimonials = [
  {
    ...
    role: "Founder & CEO",
    content: "Keylink Corp made our company formation process incredibly smooth. Within a week, we had our CR and were ready to operate. Their knowledge of Bahrain regulations is exceptional.",
    rating: 5,
    image: testimonial1,
  },
  {
    ...
    content: "As a foreign investor, I was concerned about the complexities of setting up in Bahrain. Keylink Corp's expertise made the entire process seamless. Highly recommend their services!",
    rating: 5,
    image: testimonial2,
  },
  {
    ...
    role: "Business Owner",
    content: "The PRO services have saved us countless hours. Their team handles all our government documentation efficiently. Worth every fils.",
    rating: 5,
    image: testimonial3,
  },
];
      ...
      <div className="container relative">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground leading-[1.8]">
            Don't just take our word for it. Here's what business owners say about their company formation experience.
          </p>
        </motion.div>
        ...
        >
          {/* Google Reviews */}
          <div className="flex items-center gap-3 px-6 py-3 bg-white rounded-full border border-border">
