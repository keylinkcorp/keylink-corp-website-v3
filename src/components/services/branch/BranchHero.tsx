...
import heroImage from "@/assets/branch-hero-professional.jpg";
...
const heroFeatures = [
  ...
  { icon: Clock, text: "7-10 Days Setup" },
  { icon: Building2, text: "No Minimum Capital" },
];
      ...
      <div className="container py-32 lg:py-40">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="max-w-xl">
            ...
            >
              <span className="text-sm font-medium text-accent">Expand Your International Presence</span>
            </motion.div>
            ...
            >
              Extend your international company into Bahrain's tax-free market. Register your foreign company branch with 100% ownership, full profit repatriation, and complete MOIC support.
            </motion.p>
            ...
            >
              <p className="text-sm text-muted-foreground">
                Registered with <span className="font-medium text-primary">MOIC</span> • <span className="font-medium text-primary">Sijilat</span> • <span className="font-medium text-primary">LMRA</span> • <span className="font-medium text-primary">Chamber</span>
              </p>
            </motion.div>
          </div>
          ...
          >
            <div className="relative">
              ...
              <div className="rounded-2xl overflow-hidden shadow-sm relative">
                <img 
                  src={heroImage} 
                  alt="International executive establishing branch office in Bahrain" 
                ...
                >
                  ...
                  <p className="text-2xl font-bold text-accent">BHD 1,200</p>
                </motion.div>
                ...
                >
                  ...
                  <p className="text-xs text-white/80">Branches Registered</p>
                </motion.div>
              </div>
            </div>
          </motion.div>
