...
const stats = [
  { icon: Building2, value: 120, suffix: "+", label: "Branches Registered" },
  { icon: Clock, value: 10, suffix: "+", label: "Years Experience" },
  { icon: Award, value: 100, suffix: "%", label: "Success Rate" },
  { icon: CheckCircle, value: 7, suffix: "-10 Days", label: "Average Setup Time" },
];

export function BranchTrustBar() {
  ...
  return (
    <section ref={ref} className="py-12 bg-primary">
      <div className="container mx-auto px-4">
        ...
        >
          Bahrain's Trusted Branch Registration Partner — Serving International Companies Since 2014
        </motion.p>
      </div>
    </section>
  );
